# Operator Quickstart — Community Hazardous Waste Collection

Shortest path from clone to a verified local dry-run for **ISIC 3812** (`cloud-itonami-isic-3812`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-3812.git
cd cloud-itonami-isic-3812
```
...
- Blueprint governor key: `hazardous-waste-governor`
- Likely source path: `src/**/hazardous-waste-governor.cljc`
